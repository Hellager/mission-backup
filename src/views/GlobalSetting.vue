<template>
    <div class="container">
        <page-header :title="t('component.pageHeaderGlobalSetting')" to="/" />
                ...
                <el-row :gutter="10" justify="space-between">
                    ...
                    <el-col :span="12" :pull="2">
                        <el-form-item :label="t('setting.resetPassword')">
                            <el-button type="primary" @click="change_password_dialog_visiable = true">{{ t('setting.clickToReset') }}</el-button>
                        </el-form-item>
                    </el-col>
                    <el-col :span="12">
                        <el-form-item :label="t('setting.resetMonitorDelay')">
                            <el-button type="primary" @click="change_delay_dialog_visiable = true">{{ t('setting.clickToReset') }}</el-button>
                        </el-form-item>
                    </el-col>
                    <el-col :span="12" :pull="2">
                        <el-form-item :label="t('setting.version')">
                            <div class="software-version">{{software_version}}</div>
                        </el-form-item>
                    </el-col>
                </el-row>
            </el-form>
        ...
        <el-dialog v-model="change_password_dialog_visiable" :show-close="false" :title="t('setting.resetPassword')">
            <el-form class="setting-dialog" label-position="right" :label-width="language == 'zh-CN' ? 'auto' : '110px'">
              <el-form-item :label="t('setting.originPassword')">
                <el-input class="oldPasswordInput" v-model="input_origin_password" show-password />
              </el-form-item>
